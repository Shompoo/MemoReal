...
@implementation MemoRealAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //self.viewController = [[MemoRealViewController alloc] initWithNibName:@"MemoRealViewController" bundle:nil];
  
    self.arViewController = [[CamViewController alloc] init];
    
    
    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:self.arViewController];
    
    MMRMenuViewController *menuController = [[MMRMenuViewController alloc]init];
